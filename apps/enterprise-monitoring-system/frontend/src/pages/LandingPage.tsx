...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-luxury-black text-slate-900 dark:text-white selection:bg-luxury-blue/30 overflow-x-hidden font-sans scroll-smooth transition-colors duration-500 relative">
      {/* Sticky Scroll Progress Bar */}
      <motion.div 
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-luxury-blue via-luxury-cyan to-luxury-accent z-[200] origin-left"
      ...
      <section ref={heroRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        <motion.div style={{ opacity, scale, y }} className="relative z-10 text-center px-8">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-1.5 rounded-full bg-luxury-blue/10 border border-luxury-blue/20 text-[10px] font-black uppercase tracking-[0.4em] text-luxury-blue mb-10 shadow-lg shadow-luxury-blue/10 animate-pulse">
        ...
        <div className="absolute inset-0 z-0">
          ...
          />
          {/* Animated Glows */}
          <motion.div style={{ rotate: rotateOrb }} className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-luxury-blue/10 rounded-full blur-[150px] animate-pulse" />
          <motion.div style={{ rotate: rotateOrb }} className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-luxury-accent/10 rounded-full blur-[150px] animate-pulse delay-1000" />
        </div>
      ...
      {/* Product Showcase */}
      <section id="product" className="py-32 bg-white dark:bg-luxury-black relative overflow-hidden">
        <motion.div style={{ y: bgY1 }} className="absolute inset-0 bg-gradient-to-b from-transparent via-luxury-blue/5 to-transparent pointer-events-none" />
              ...
              <div className="absolute top-12 left-12 z-20 space-y-4">
                {['Real-time Telemetry', 'AI Behavioral Analysis', 'Predictive Attrition'].map((tag, i) => (
                  <motion.div 
                    ...
                    className="px-6 py-3 bg-luxury-black/40 backdrop-blur-xl border border-white/10 rounded-2xl flex items-center gap-3 shadow-xl"
                  >
                    <div className="h-2 w-2 rounded-full bg-luxury-blue animate-pulse" />
      ...
      <section className="py-20 bg-luxury-blue/5 border-y border-luxury-blue/10 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-2 lg:grid-cols-4 gap-12 text-center relative z-10">
          {[
            ...
            <motion.div
              ...
              className="p-8 rounded-3xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-luxury-cyan/40 transition-all group shadow-xl"
            >
              <motion.div 
                initial={{ scale: 1 }}
                whileHover={{ scale: 1.1 }}
                className="text-5xl lg:text-6xl font-display font-black text-transparent bg-clip-text bg-gradient-to-r from-luxury-blue to-luxury-cyan mb-2 italic"
              >
                {stat.value}
              </motion.div>
              <div className="text-sm font-bold uppercase tracking-widest text-slate-900 dark:text-white mb-1">{stat.label}</div>
        ...
        <motion.div 
          style={{ y: bgY2 }}
          className="absolute inset-0 bg-gradient-to-r from-luxury-blue/5 via-transparent to-luxury-accent/5 pointer-events-none" 
        />
      </section>
      ...
      {/* Resources & FAQ */}
      <section id="resources" className="py-32 bg-white dark:bg-white/5 border-y border-slate-200 dark:border-white/5 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 relative z-10">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
               {[
                 ...
                 <motion.div 
                   ...
                   className="p-8 bg-white dark:bg-luxury-black/60 border border-slate-200 dark:border-white/5 rounded-[40px] hover:border-luxury-blue/40 transition-all group cursor-pointer shadow-lg shadow-slate-100 dark:shadow-none"
                 >
